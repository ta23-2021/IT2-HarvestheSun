	...
	<tfoot>
		...
		if (Ezfc_Functions::get_array_value($summary_data["form_options"], "email_show_total_price", 1) == 1 && Ezfc_Functions::get_array_value($summary_data["form_options"], "hide_summary_price", 0) == 0) {
			...
			<tr style="font-weight: bold;">
				<td style="background-color: <?php echo $summary_bg_color; ?>; font-weight: bold; padding: 5px; vertical-align: top;"><?php echo __("Total", "ezfc"); ?></td>
				<td style="background-color: <?php echo $summary_text_color; ?>; font-weight: bold; padding: 5px; vertical-align: top;"><?php echo $summary_data["total_formatted"]; ?></td>
			</tr>
		<?php
		}
		?>
