...
export default () => {
	...
	return (
		<section className="ct-comparison-table">
			...
			<div className="ct-cta-container-small">
				<h2>{__('Blocksy Pro - 10% OFF!', 'blocksy')}</h2>

				<a
					href="https://creativethemes.com/blocksy/pricing/?coupon=BlocksyLimited10&utm_source=getpro&utm_medium=dashboard&utm_campaign=BlocksyLimited10"
			...
			<div className="ct-cta-container">
				...
				<p>
					{__(
						'Hey friends, for a limited time you can get advantage of Blocksy Pro with a 10% discount on all our premium packages, hurry up this offer will end soon!',
						'blocksy'
					)}
				</p>
				<a
